...
const processSteps = [
  ...
  },
  {
    ...
    description: "Browse colors, materials, and packages. Our simple style guide makes choosing easy and stress-free."
  },
  {
    step: 4,
    icon: Camera,
    title: "See Your New Look",
    description: "View realistic photos of your home with your selected roof. See exactly what you're buying before you buy."
  },
  {
    step: 5,
    icon: CreditCard,
    title: "Complete Your Purchase",
    description: "Get transparent pricing and schedule installation. All online, no sales calls, zero hassle."
  }
]

const trustIndicators = [
  { text: "Stress-Free Process", subtext: "No Sales Pressure", icon: Ban },
  { text: "See What You're Buying", subtext: "Virtual Visualization", icon: Eye },
  { text: "Know Before You Buy", subtext: "No Hidden Surprises", icon: BookOpen }
]
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-5xl lg:text-7xl font-bold text-slate-800 mb-6 leading-tight">
                Buy Your Roof Like You
                <span className="block text-orange-600">Buy Your Coffee</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
                Simple, fast, and exactly what you ordered.<br/>
                <span className="text-lg text-gray-600">No sales pressure. No surprises. Roofing made simple.</span>
              </p>
      ...
      {/* Wherever you need us section */}
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-4">
            <p className="text-lg text-gray-600 font-medium">Serving all of Chicagoland</p>
            <h2 className="text-4xl font-bold text-gray-900">Roofing Made Simple</h2>
          </div>
        </div>
      </section>
